...
write_csv(IT_79_Home, here(
  'OUTPUT-FILES/NORMS-OUTPUT-4080T/IT-79-Home-T-Scores-per-case-4080T.csv'
  # paste0(
...
write_csv(all_lookup, here(
  'OUTPUT-FILES/NORMS-OUTPUT-4080T/IT-79-Home-raw-T-lookup-4080T.csv'
  # paste0(
...
write_csv(all_lookup_pub, here(
  'OUTPUT-FILES/NORMS-OUTPUT-4080T/IT-79-Home-print-raw-T-lookup-4080T.csv'
    # paste0(
...
write_csv(IT_79_Home_raw_desc, here(
  'OUTPUT-FILES/IT/DESCRIPTIVES/IT-79-Home-raw-desc.csv'
  # paste0(
...
write_csv(IT_79_Home_demo_counts, here(
  'OUTPUT-FILES/IT/DESCRIPTIVES/IT-79-Home-demo-counts.csv'
  # paste0(
