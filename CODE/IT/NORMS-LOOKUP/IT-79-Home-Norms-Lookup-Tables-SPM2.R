...
write_csv(IT_79_Home, here(
  'OUTPUT-FILES/IT/T-SCORES-PER-CASE/IT-79-Home-T-Scores-per-case.csv'
  # paste0(
...
write_csv(all_lookup, here(
  'OUTPUT-FILES/IT/RAW-T-LOOKUP-TABLES/IT-79-Home-raw-T-lookup.csv'
  # paste0(
...
write_csv(all_lookup_pub, here(
  'OUTPUT-FILES/IT/PRINT-FORMAT-NORMS-TABLES/IT-79-Home-print-raw-T-lookup.csv'
    # paste0(
