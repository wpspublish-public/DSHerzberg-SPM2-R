...
All_items_IT_2130_Home <- c("q0011", "q0012", "q0013", "q0014", "q0015", "q0016", "q0017", "q0018", "q0019", "q0022", 
...
TOT_items_IT_2130_Home <- c("q0024", "q0025", "q0026", "q0027", "q0028", "q0029", "q0032", "q0034", "q0035", "q0036", 
                            "q0037", "q0038", "q0039", "q0040", "q0041", "q0042", "q0043", "q0044", "q0045", "q0046", 
                            "q0052", "q0054", "q0055", "q0056", "q0061", "q0062", "q0063", "q0066", "q0067", "q0068", 
                            "q0069", "q0071", "q0073", "q0075", "q0076", "q0077", "q0079", "q0080", "q0081", "q0082", 
                            "q0086", "q0087", "q0088", "q0089", "q0091", "q0093", "q0095", "q0096", "q0097", "q0098", 
...
SOC_items_IT_2130_Home <- c("q0011", "q0012", "q0013", "q0014", "q0015", "q0016", "q0017", "q0018", "q0019", "q0022")

SOC_rev_items_IT_2130_Home <- c("q0011", "q0012", "q0013", "q0014", "q0015", "q0016", "q0017", "q0018", "q0019", "q0022")

VIS_items_IT_2130_Home <- c("q0024", "q0025", "q0026", "q0027", "q0028", "q0029", "q0032", "q0034", "q0035", "q0036")

HEA_items_IT_2130_Home <- c("q0037", "q0038", "q0039", "q0040", "q0041", "q0042", "q0043", "q0044", "q0045", "q0046")

TOU_items_IT_2130_Home <- c("q0052", "q0054", "q0055", "q0056", "q0061", "q0062", "q0063", "q0066", "q0067", "q0068")

TS_items_IT_2130_Home <- c("q0069", "q0071", "q0073", "q0075", "q0076", "q0077", "q0079", "q0080", "q0081", "q0082")

BOD_items_IT_2130_Home <- c("q0086", "q0087", "q0088", "q0089", "q0091", "q0093", "q0095", "q0096", "q0097", "q0098")

BAL_items_IT_2130_Home <- c("q0100", "q0101", "q0102", "q0103", "q0104", "q0105", "q0106", "q0107", "q0110", "q0112")

PLA_items_IT_2130_Home <- c("q0114", "q0117", "q0118", "q0119", "q0120", "q0121", "q0122", "q0123", "q0124", "q0125")
...
IT_2130_Home <-
  suppressMessages(as_tibble(read_csv(
    ...
    Ethnicity,
    Region,
    All_items_IT_2130_Home
  ) %>%
  # filter for age stratification
  filter(AgeInMonths %in% c(21:30)) %>%
  mutate(agestrat = "21-30 mo") %>%
  ...
  mutate_at(All_items_IT_2130_Home,
            ~ as.integer(.x)) %>% 
  # Compute raw scores. Note use of `rowSums(.[TOT_items_IT_2130_Home])`: when used 
  # within a pipe, you can pass a vector of column names to `base::rowSums`, but you
  # must wrap the column vector in a column-subsetting expression: `.[]`, where the
  # dot is a token for the data in the pipe.
  mutate(
    TOT_raw = rowSums(.[TOT_items_IT_2130_Home]),
    SOC_raw = rowSums(.[SOC_items_IT_2130_Home]),
    VIS_raw = rowSums(.[VIS_items_IT_2130_Home]),
    HEA_raw = rowSums(.[HEA_items_IT_2130_Home]),
    TOU_raw = rowSums(.[TOU_items_IT_2130_Home]),
    TS_raw = rowSums(.[TS_items_IT_2130_Home]),
    BOD_raw = rowSums(.[BOD_items_IT_2130_Home]),
    BAL_raw = rowSums(.[BAL_items_IT_2130_Home]),
    PLA_raw = rowSums(.[PLA_items_IT_2130_Home])
  ) %>% 
  select(
    -(q0011:q0125)
  ) %>% 
...
rm(list = ls(pattern='.*items_IT_2130_Home'))
...
# IT_2130_Home_TOT_freq_agestrat <- IT_2130_Home %>% group_by(agestrat) %>% count(TOT_raw) %>% 
...
# IT_2130_Home_TOT_desc_agestrat <-
#   IT_2130_Home %>% group_by(agestrat) %>% arrange(agestrat) %>% summarise(n = n(),
...
# 
# agestrat <- IT_2130_Home_TOT_desc_agestrat %>% pull(agestrat)

# Plot TOT_raw means, SDs by agestrat
# mean_plot <- ggplot(data = IT_2130_Home_TOT_desc_agestrat, aes(group, mean)) +
#   geom_point(
#     col = "blue",
#     fill = "blue",
#     alpha = .5,
...
# IT_2130_Home_dup <- IT_2130_Home %>% count(IDNumber) %>% filter(n > 1)
# write_csv(IT_2130_Home_dup, here("DATA/IT_2130_Home_dup.csv"))
