...
# All_items_IT_46_Home <- c("q0010", "q0011", "q0012", "q0013", "q0014", "q0015", "q0016", "q0017", "q0019", "q0023", 
...
# 
# 
# TOT_items_IT_46_Home <- c("q0026", "q0027", "q0028", "q0029", "q0030", "q0031", "q0032", "q0035", "q0037", "q0038", 
#                      "q0039", "q0040", "q0042", "q0044", "q0045", "q0046", "q0047", "q0048", "q0049", "q0050", 
#                      "q0052", "q0053", "q0054", "q0055", "q0057", "q0058", "q0061", "q0063", "q0065", "q0066", 
#                      "q0067", "q0068", "q0070", "q0072", "q0073", "q0074", "q0075", "q0076", "q0077", "q0078", 
#                      "q0080", "q0081", "q0083", "q0084", "q0085", "q0087", "q0088", "q0089", "q0090", "q0091", 
#                      "q0092", "q0093", "q0095", "q0097", "q0098", "q0100", "q0101", "q0102", "q0104", "q0105")
# 
# SOC_items_IT_46_Home <- c("q0010", "q0011", "q0012", "q0013", "q0014", "q0015", "q0016", "q0017", "q0019", "q0023")
# 
# SOC_rev_items_IT_46_Home <- c("q0010", "q0011", "q0012", "q0013", "q0014", "q0015", "q0016", "q0017", "q0019", "q0023")
# 
# VIS_items_IT_46_Home <- c("q0026", "q0027", "q0028", "q0029", "q0030", "q0031", "q0032", "q0035", "q0037", "q0038")
# 
# HEA_items_IT_46_Home <- c("q0039", "q0040", "q0042", "q0044", "q0045", "q0046", "q0047", "q0048", "q0049", "q0050")
# 
# TOU_items_IT_46_Home <- c("q0052", "q0053", "q0054", "q0055", "q0057", "q0058", "q0061", "q0063", "q0065", "q0066")
# 
# TS_items_IT_46_Home <- c("q0067", "q0068", "q0070", "q0072", "q0073", "q0074", "q0075", "q0076", "q0077", "q0078")
# 
# BOD_items_IT_46_Home <- c("q0080", "q0081", "q0083", "q0084", "q0085", "q0087", "q0088", "q0089", "q0090", "q0091")
# 
# BAL_items_IT_46_Home <- c("q0092", "q0093", "q0095", "q0097", "q0098", "q0100", "q0101", "q0102", "q0104", "q0105")
# 
# PLA_items_IT_46_Home <- c("q0109", "q0110", "q0111", "q0113", "q0114", "q0115", "q0116", "q0117", "q0118", "q0119")
# 
...
#             ~ as.integer(.x)) %>% 
#   # Compute raw scores. Note use of `rowSums(.[TOT_items_IT_46_Home])`: when used 
#   # within a pipe, you can pass a vector of column names to `base::rowSums`, but you
#   # must wrap the column vector in a column-subsetting expression: `.[]`, where the
#   # dot is a token for the data in the pipe.
#   mutate(
#     TOT_raw = rowSums(.[TOT_items_IT_46_Home]),
#     SOC_raw = rowSums(.[SOC_items_IT_46_Home]),
#     VIS_raw = rowSums(.[VIS_items_IT_46_Home]),
#     HEA_raw = rowSums(.[HEA_items_IT_46_Home]),
#     TOU_raw = rowSums(.[TOU_items_IT_46_Home]),
#     TS_raw = rowSums(.[TS_items_IT_46_Home]),
#     BOD_raw = rowSums(.[BOD_items_IT_46_Home]),
...
write_csv(IT_46_Home_raw_desc, here(
  paste0(
    'OUTPUT-FILES/IT/DESCRIPTIVES/IT-46-Home-raw-desc-',
    format(Sys.Date(), "%Y-%m-%d"),
    '.csv'
  )
), 
...
IT_46_Home_demo_counts <- IT_46_Home %>% 
...
write_csv(IT_46_Home_demo_counts, here(
  paste0(
    'OUTPUT-FILES/IT/DESCRIPTIVES/IT-46-Home-demo-counts-',
    format(Sys.Date(), "%Y-%m-%d"),
    '.csv'
  )
), 
