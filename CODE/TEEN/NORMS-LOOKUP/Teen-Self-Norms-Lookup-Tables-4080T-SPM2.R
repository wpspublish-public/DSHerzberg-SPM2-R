...
write_csv(Teen_1221_Self, here(
  'OUTPUT-FILES/NORMS-OUTPUT-4080T/Teen-1221-Self-T-Scores-per-case-4080T.csv'
  # paste0(
...
write_csv(all_lookup, here(
  'OUTPUT-FILES/NORMS-OUTPUT-4080T/Teen-1221-Self-raw-T-lookup-4080T.csv'
  # paste0(
...
write_csv(all_lookup_pub, here(
  'OUTPUT-FILES/NORMS-OUTPUT-4080T/Teen-1221-Self-print-raw-T-lookup-4080T.csv'
    # paste0(
