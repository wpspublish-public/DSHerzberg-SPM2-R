...
write_csv(Adult_Other, here(
  'OUTPUT-FILES/NORMS-OUTPUT-4080T/Adult-Other-T-Scores-per-case-4080T.csv'
  # paste0(
...
write_csv(all_lookup, here(
  'OUTPUT-FILES/NORMS-OUTPUT-4080T/Adult-Other-raw-T-lookup-4080T.csv'
  # paste0(
...
write_csv(all_lookup_pub, here(
  'OUTPUT-FILES/NORMS-OUTPUT-4080T/Adult-Other-print-raw-T-lookup-4080T.csv'
    # paste0(
