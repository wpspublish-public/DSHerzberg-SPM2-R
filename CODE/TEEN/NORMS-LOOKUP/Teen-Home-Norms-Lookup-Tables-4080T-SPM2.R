...
Teen_1221_Home_dupMissIDs <- Teen_1221_Home %>%
  ...
  write_csv(
    here(
      paste0(
        'OUTPUT-FILES/TEEN/DUP-IDS/Teen-1221-Home-dupIDs-missingIDs-',
...
write_csv(Teen_1221_Home, here(
  'OUTPUT-FILES/NORMS-OUTPUT-4080T/Teen-1221-Home-T-Scores-per-case-4080T.csv'
  # paste0(
...
write_csv(all_lookup, here(
  'OUTPUT-FILES/NORMS-OUTPUT-4080T/Teen-1221-Home-raw-T-lookup-4080T.csv'
  # paste0(
...
write_csv(all_lookup_pub, here(
  'OUTPUT-FILES/NORMS-OUTPUT-4080T/Teen-1221-Home-print-raw-T-lookup-4080T.csv'
    # paste0(
