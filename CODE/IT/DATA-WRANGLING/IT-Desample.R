...
IT_430_Home_desamp <- IT_430_Home_desamp1 %>% 
  anti_join(
    IT_430_Home_stage2, 
    by = 'IDNumber'
  )

anyDuplicated(IT_430_Home_desamp$IDNumber)

# Check for any NAs on IDNumber, returns TRUE if NA exist
any(is.na(IT_430_Home_desamp$IDNumber))

# extract cases with Dup ID numbers or NA on IDNumber, write out for investigation
# IT_430_Home_dupMissIDs <- IT_430_Home_desamp %>% 
...
#     here(
#       paste0(
#         'OUTPUT-FILES/IT/DUP-IDS/IT-430-Home-dupIDs-missingIDs-',
