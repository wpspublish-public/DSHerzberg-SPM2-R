...
IT_Caregiver_dupMissIDs <- IT_Caregiver %>% 
  ...
  write_csv(
    here(
      paste0(
        'OUTPUT-FILES/IT/DUP-IDS/IT-Caregiver-dupIDs-missingIDs-',
...
write_csv(IT_Caregiver, here(
  'OUTPUT-FILES/NORMS-OUTPUT-4080T/IT-Caregiver-T-Scores-per-case-4080T.csv'
  # paste0(
...
write_csv(all_lookup, here(
  'OUTPUT-FILES/NORMS-OUTPUT-4080T/IT-Caregiver-raw-T-lookup-4080T.csv'
  # paste0(
...
write_csv(all_lookup_pub, here(
  'OUTPUT-FILES/NORMS-OUTPUT-4080T/IT-Caregiver-print-raw-T-lookup-4080T.csv'
    # paste0(
