...
All_items_Preschool_5_School <- c("q0014", "q0015", "q0016", "q0017", "q0018", "q0019", "q0020", "q0021", "q0022", "q0024", 
...
TOT_items_Preschool_5_School <- c("q0026", "q0027", "q0028", "q0029", "q0030", "q0031", "q0032", "q0033", "q0034", "q0035", 
                                   "q0038", "q0039", "q0041", "q0042", "q0043", "q0045", "q0046", "q0047", "q0048", "q0050", 
                                   "q0052", "q0053", "q0054", "q0057", "q0058", "q0059", "q0060", "q0061", "q0062", "q0063", 
                                   "q0064", "q0065", "q0066", "q0067", "q0068", "q0069", "q0070", "q0071", "q0074", "q0076", 
                                   "q0077", "q0078", "q0079", "q0080", "q0081", "q0083", "q0084", "q0086", "q0088", "q0090", 
...
SOC_items_Preschool_5_School <- c("q0014", "q0015", "q0016", "q0017", "q0018", "q0019", "q0020", "q0021", "q0022", "q0024")

SOC_rev_items_Preschool_5_School <- c("q0014", "q0015", "q0016", "q0017", "q0018", "q0019", "q0020", "q0021", "q0022", "q0024")

VIS_items_Preschool_5_School <- c("q0026", "q0027", "q0028", "q0029", "q0030", "q0031", "q0032", "q0033", "q0034", "q0035")

HEA_items_Preschool_5_School <- c("q0038", "q0039", "q0041", "q0042", "q0043", "q0045", "q0046", "q0047", "q0048", "q0050")

TOU_items_Preschool_5_School <- c("q0052", "q0053", "q0054", "q0057", "q0058", "q0059", "q0060", "q0061", "q0062", "q0063")

TS_items_Preschool_5_School <- c("q0064", "q0065", "q0066", "q0067", "q0068", "q0069", "q0070", "q0071", "q0074", "q0076")

BOD_items_Preschool_5_School <- c("q0077", "q0078", "q0079", "q0080", "q0081", "q0083", "q0084", "q0086", "q0088", "q0090")

BAL_items_Preschool_5_School <- c("q0091", "q0093", "q0094", "q0095", "q0096", "q0097", "q0099", "q0100", "q0101", "q0104")

PLA_items_Preschool_5_School <- c("q0105", "q0106", "q0108", "q0110", "q0111", "q0112", "q0113", "q0114", "q0115", "q0117")
...
Preschool_5_School <-
  ...
  mutate_at(
    SOC_rev_items_Preschool_5_School,
    ~ case_when(.x == 4 ~ 1,
                .x == 3 ~ 2,
                .x == 2 ~ 3,
                .x == 1 ~ 4,
  ...
  mutate_at(All_items_Preschool_5_School,
            ~ as.integer(.x)) %>% 
  # Compute raw scores. Note use of `rowSums(.[TOT_items_Preschool_5_School])`: when used 
  # within a pipe, you can pass a vector of column names to `base::rowSums`, but you
  # must wrap the column vector in a column-subsetting expression: `.[]`, where the
  # dot is a token for the data in the pipe.
  mutate(
    TOT_raw = rowSums(.[TOT_items_Preschool_5_School]),
    SOC_raw = rowSums(.[SOC_items_Preschool_5_School]),
    VIS_raw = rowSums(.[VIS_items_Preschool_5_School]),
    HEA_raw = rowSums(.[HEA_items_Preschool_5_School]),
    TOU_raw = rowSums(.[TOU_items_Preschool_5_School]),
    TS_raw = rowSums(.[TS_items_Preschool_5_School]),
    BOD_raw = rowSums(.[BOD_items_Preschool_5_School]),
    BAL_raw = rowSums(.[BAL_items_Preschool_5_School]),
    PLA_raw = rowSums(.[PLA_items_Preschool_5_School])
  ) %>% 
  #select(
  #  -(q0014:q0117)
  #) %>% 
...
rm(list = ls(pattern='.*items_Preschool_5_School'))
...
# Preschool_5_School_TOT_freq_AgeGroup <- Preschool_5_School %>% group_by(AgeGroup) %>% count(TOT_raw) %>% 
...
# Preschool_5_School_TOT_desc_AgeGroup <-
#   Preschool_5_School %>% group_by(AgeGroup) %>% arrange(AgeGroup) %>% summarise(n = n(),
...
# 
# AgeGroup <- Preschool_5_School_TOT_desc_AgeGroup %>% pull(AgeGroup)

# Plot TOT_raw means, SDs by AgeGroup
# mean_plot <- ggplot(data = Preschool_5_School_TOT_desc_AgeGroup, aes(group, mean)) +
#   geom_point(
#     col = "blue",
#     fill = "blue",
#     alpha = .5,
...
# Preschool_5_School_dup <- Preschool_5_School %>% count(IDNumber) %>% filter(n > 1)
# write_csv(Preschool_5_School_dup, here("DATA/Preschool_5_School_dup.csv"))
...
# TOT_nz_obj <- bestNormalize(Preschool_5_School$TOT_raw)
# 
...
# TOT_nz_transform <- eval(as.name(chosen_transform))(Preschool_5_School$TOT_raw)
...
raw_score_cols_list <- map(score_names, ~ Preschool_5_School %>% 
              pull(
...
# each case.
Preschool_5_School <- Preschool_5_School %>% bind_cols(NT_cols)

# write T-scores per case table to .csv
write_csv(Preschool_5_School, here(
  paste0(
    'OUTPUT-FILES/PRESCHOOL/T-SCORES-PER-CASE/Preschool-5-School-T-Scores-per-case-',
...
# MASS::truehist(Preschool_5_School$TOT_NT, h = 1)
# hist_plot <- ggplot(data = Preschool_5_School, aes(TOT_NT)) +
#   geom_histogram(
#     binwidth = .2,
#     col = "red"
#   ) +
...
TOT_lookup <- Preschool_5_School %>% group_by(
  TOT_raw
) %>% 
...
write_csv(all_lookup, here(
  paste0(
    'OUTPUT-FILES/PRESCHOOL/RAW-T-LOOKUP-TABLES/Preschool-5-School-raw-T-lookup-',
    format(Sys.Date(), "%Y-%m-%d"),
    '.csv'
  )
), 
...
write_csv(all_lookup_pub, here(
  paste0(
    'OUTPUT-FILES/PRESCHOOL/PRINT-FORMAT-NORMS-TABLES/Preschool-5-School-print-raw-T-lookup-',
    format(Sys.Date(), "%Y-%m-%d"),
    '.csv'
  )
), 
...
write_csv(Preschool_5_School_raw_desc, here(
  paste0(
    'OUTPUT-FILES/PRESCHOOL/DESCRIPTIVES/Preschool-5-School-raw-desc-',
    format(Sys.Date(), "%Y-%m-%d"),
    '.csv'
  )
), 
...
cat_order <- c("5 yr",
               "Male", "Female", 
               "Hispanic", "Asian", "Black", "White", "AmericanIndAlaskanNat", "MultiRacial", 
               "northeast", "midwest", "south", "west")                                   


Preschool_5_School_demo_counts <- Preschool_5_School %>% 
...
write_csv(Preschool_5_School_demo_counts, here(
  paste0(
    'OUTPUT-FILES/PRESCHOOL/DESCRIPTIVES/Preschool-5-School-demo-counts-',
    format(Sys.Date(), "%Y-%m-%d"),
    '.csv'
  )
), 
