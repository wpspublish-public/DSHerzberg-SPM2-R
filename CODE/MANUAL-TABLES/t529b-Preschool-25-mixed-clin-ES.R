...
write_csv(
  match_dist,
  here(
    'OUTPUT-FILES/MANUAL-TABLES/t529b-Preschool-25-mixed-clin-matchDemos.csv'
  ),
  na = ''
)
...
write_csv(
  Preschool_25_match_t_desc,
  here(
    'OUTPUT-FILES/MANUAL-TABLES/t529b-Preschool-25-mixed-clin-ES.csv'
  ),
  na = ''
)
