...
write_csv(Preschool_5_Home, here(
  'OUTPUT-FILES/NORMS-OUTPUT-4080T/Preschool-5-Home-T-Scores-per-case-4080T.csv'
  # paste0(
...
write_csv(all_lookup, here(
  'OUTPUT-FILES/NORMS-OUTPUT-4080T/Preschool-5-Home-raw-T-lookup-4080T.csv'
  # paste0(
...
write_csv(all_lookup_pub, here(
  'OUTPUT-FILES/NORMS-OUTPUT-4080T/Preschool-5-Home-print-raw-T-lookup-4080T.csv'
    # paste0(
