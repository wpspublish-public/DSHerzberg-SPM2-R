...
write_csv(Preschool_5_School, here(
  'OUTPUT-FILES/PRESCHOOL/T-SCORES-PER-CASE/Preschool-5-School-T-Scores-per-case.csv'
  # paste0(
...
write_csv(all_lookup, here(
  'OUTPUT-FILES/PRESCHOOL/RAW-T-LOOKUP-TABLES/Preschool-5-School-raw-T-lookup.csv'
  # paste0(
...
write_csv(all_lookup_pub, here(
  'OUTPUT-FILES/PRESCHOOL/PRINT-FORMAT-NORMS-TABLES/Preschool-5-School-print-raw-T-lookup.csv'
    # paste0(
...
write_csv(Preschool_5_School_raw_desc, here(
  'OUTPUT-FILES/PRESCHOOL/DESCRIPTIVES/Preschool-5-School-raw-desc.csv'
  # paste0(
...
Preschool_5_School_demo_counts <- Preschool_5_School %>% 
  select(data, Age, Gender, Ethnicity, Region) %>% 
...
write_csv(Preschool_5_School_demo_counts, here(
  'OUTPUT-FILES/PRESCHOOL/DESCRIPTIVES/Preschool-5-School-demo-counts.csv'
  # paste0(
