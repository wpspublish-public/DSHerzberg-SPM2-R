...
write_csv(Adult_Self, here(
  'OUTPUT-FILES/NORMS-OUTPUT-4080T/Adult-Self-T-Scores-per-case-4080T.csv'
  # paste0(
...
write_csv(all_lookup, here(
  'OUTPUT-FILES/NORMS-OUTPUT-4080T/Adult-Self-raw-T-lookup-4080T.csv'
  # paste0(
...
write_csv(all_lookup_pub, here(
  'OUTPUT-FILES/NORMS-OUTPUT-4080T/Adult-Self-print-raw-T-lookup-4080T.csv'
    # paste0(
