...
write_csv(IT_2130_Home, here(
  'OUTPUT-FILES/NORMS-OUTPUT-4080T/IT-2130-Home-T-Scores-per-case-4080T.csv'
  # paste0(
...
write_csv(all_lookup, here(
  'OUTPUT-FILES/NORMS-OUTPUT-4080T/IT-2130-Home-raw-T-lookup-4080T.csv'
  # paste0(
...
write_csv(all_lookup_pub, here(
  'OUTPUT-FILES/NORMS-OUTPUT-4080T/IT-2130-Home-print-raw-T-lookup-4080T.csv'
    # paste0(
...
write_csv(IT_2130_Home_raw_desc, here(
  'OUTPUT-FILES/IT/DESCRIPTIVES/IT-2130-Home-raw-desc.csv'
  # paste0(
...
write_csv(IT_2130_Home_demo_counts, here(
  'OUTPUT-FILES/IT/DESCRIPTIVES/IT-2130-Home-demo-counts.csv'
  # paste0(
